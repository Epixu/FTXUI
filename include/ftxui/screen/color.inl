...
namespace ftxui {
namespace {
constexpr std::array<std::string_view, 33> palette16code = {
    "30", "40",   //
    "31", "41",   //
    "32", "42",   //
    "33", "43",   //
...
inline std::string Color::Print(bool is_background_color) const {
  if (is_background_color) {
    switch (type_) {
      case ColorType::Palette1:
        return "49";
      case ColorType::Palette16:
        return std::string(palette16code[2 * red_ + 1]);  // NOLINT
    ...
    switch (type_) {
      case ColorType::Palette1:
        return "39";
      case ColorType::Palette16:
        return std::string(palette16code[2 * red_]);  // NOLINT
      case ColorType::Palette256:
...
/// @ingroup screen
// static
constexpr Color Color::RGB(uint8_t red, uint8_t green, uint8_t blue) {
...
/// @see Color::RGB
// static
constexpr Color Color::RGBA(uint8_t red, uint8_t green, uint8_t blue, uint8_t alpha) {
...
/// @ingroup screen
// static
constexpr Color Color::HSVA(uint8_t h, uint8_t s, uint8_t v, uint8_t alpha) {
...
/// @ingroup screen
// static
constexpr Color Color::HSV(uint8_t h, uint8_t s, uint8_t v) {
  return HSVA(h, s, v, 255);
}

// static
constexpr Color Color::Interpolate(float t, const Color& a, const Color& b) {
...
// static
constexpr Color Color::Blend(const Color& lhs, const Color& rhs) {
